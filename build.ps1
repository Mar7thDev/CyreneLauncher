#!/usr/bin/env pwsh
# build.ps1 ¡ª interactive build helper for CyreneLauncher
...
# ©¤©¤ Mode selection ©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤
Write-Host ""
Write-Host "  Cyrene Launcher ¡ª Build" -ForegroundColor Magenta
Write-Host ""
Write-Host "  [1] Dev    ¡ª fast build, no optimisation"
Write-Host "  [2] Prod   ¡ª trimpath + windowsgui, production tags"
Write-Host "  [3] Run    ¡ª dev build, then launch"
Write-Host ""
